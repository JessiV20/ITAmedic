...
@NgModule({
  ...
  imports: [
    ...
    MatGridListModule,FormsModule,MatIconModule, MatIcon, MatIconModule,
    MatButtonModule,
    MatFormFieldModule,
    MatInputModule,
    MatSelectModule,
  ...
  exports:[
    ...
    ReactiveFormsModule, MatTooltipModule, MatCheckboxModule, MatDialogModule, MatGridListModule,FormsModule, MatIconModule,
